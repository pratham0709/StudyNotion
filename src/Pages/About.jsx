  ...
  return (
    <div>
      ...
      <section className="border-b border-richblack-700">
        <div className="flex flex-col justify-between w-11/12 gap-10 mx-auto max-w-maxContent text-richblack-500">
      ...
      <StatsComponenet />
      <section className="flex flex-col justify-between w-11/12 gap-10 mx-auto mt-20 text-white max-w-maxContent">
        <LearningGrid />
        <ContactFormSection />
      </section>
